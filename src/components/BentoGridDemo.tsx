...
import { BentoGrid, BentoGridItem } from '@/components/magicui/BentoGird'
import {
...
const Skeleton = () => (
  <div className="size-full min-h-24 flex flex-1 rounded-xl border   border-transparent bg-neutral-100 bg-dot-black/[0.2]  [mask-img:radial-gradient(ellipse_at_center,white,transparent)] dark:border-white/[0.2] dark:bg-black dark:bg-dot-white/[0.2]"></div>
)
...
const SkeletonOne = () => {
  ...
  return (
    <motion.div
      initial="initial"
      whileHover="animate"
      className="size-full min-h-24 flex flex-1 flex-col space-y-2 bg-dot-black/[0.2] dark:bg-dot-white/[0.2]"
    >
      <motion.div
        variants={variants}
...
const SkeletonThree = () => {
  ...
  return (
    <motion.div
      ...
      className="size-full min-h-24 flex flex-1 flex-col space-y-2 rounded-lg bg-dot-black/[0.2] dark:bg-dot-white/[0.2]"
      style={{
        background:
...
const SkeletonFour = () => {
  ...
  return (
    <motion.div
      ...
      animate="animate"
      whileHover="hover"
      className="size-full min-h-24 flex flex-1 flex-row space-x-2 bg-dot-black/[0.2] dark:bg-dot-white/[0.2]"
    >
      <motion.div
        variants={first}
